...
1. ~~**Record the Strict Mode demo GIF**~~ — **DONE**. Three-act GIF (posture → kernel remembers → kernel learns) at `docs/assets/strict_mode_demo.gif`, 904 KB. Re-record after any hook change via `docs/CONTRIBUTING.md`.
