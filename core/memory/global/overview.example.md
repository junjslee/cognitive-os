...
- `CLAUDE.md` is the Claude-native memory index.
- The live project state belongs in `docs/*.md`, not in long chat transcripts.

<!-- Copy this file to overview.md and customize for your setup. -->
