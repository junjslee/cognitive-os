---
name: repo-bootstrap
description: Bootstrap a repository with the standard agent-os scaffold and verify the core memory files exist.
---
...
2. If the scaffold is missing, run `agent-os bootstrap` from the repo root.
