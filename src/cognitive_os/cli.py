...
def _sync_check(governance_mode: str = "balanced") -> int:
    ...
    # Claude CLAUDE.md
    _check_managed_target(claude_root / "CLAUDE.md", _render_user_claude_md(), "~/.claude/CLAUDE.md")
    ...
    # Hermes OPERATOR.md — managed region check
    if hermes_root.exists():
        ...
        # _sync_hermes_runtime also prepends a governance header inside the managed
        # block, so reconstruct the same text here for a faithful comparison.
        sections.append(
            "# cognitive-os Governance Declaration\n\n"
            "You are operating under the **cognitive-os** governance system.\n\n"
            "cognitive-os is the authoritative identity and reasoning layer above any agent platform. "
        ...
        for mem_file in [
            ...
            if mem_file.exists():
                sections.append(mem_file.read_text(encoding="utf-8").rstrip() + "\n\n")
        expected_managed = "".join(sections).rstrip()
        _check_managed_target(operator_md, expected_managed, "~/.hermes/OPERATOR.md")
...
def _sync_user_runtime(governance_mode: str = "balanced") -> None:
    ...
    _write_managed_file(
        ...
        _render_user_claude_md(),
        prior_signature="# cognitive-os Global Memory",
    )
